  ...
  if (disabled) {
    return (
      <div
        ...
        ref={valueRef}
        className={cn(
          "flex w-full gap-1.5 overflow-hidden opacity-50 pointer-events-none select-none",
      ...
      {[...selectedValues]
        ...
        .map(value => (
          ...
          >
            {items.get(value)}
            {clickToRemove && (
              <XIcon className="size-2 text-red-600" />
            )}
          </Badge>
        ))}
      <Badge
