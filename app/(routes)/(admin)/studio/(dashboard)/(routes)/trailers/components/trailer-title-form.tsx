...
export const TrailerTitleForm = ({ initialData, trailerId }: TitleFormPops) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.patch(`/api/series/${trailerId}/season`, values);
      toast.success("Trailer title updated!");
      toggleEdit();
      router.refresh();
    } catch (error) {
